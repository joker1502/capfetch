...
function buildContent() {
  ...
  const tools = [
    ["TikTok Caption Extractor", `${base}/tiktok-caption-extractor`, "Extract captions and transcripts from TikTok videos"],
    ["Reels Caption Extractor", `${base}/reels-caption-extractor`, "Extract captions from Instagram Reels"],
    ["Shorts Transcript Extractor", `${base}/shorts-transcript-extractor`, "Extract transcripts from YouTube Shorts"],
    ["TikTok Viral Analyzer", `${base}/tiktok-viral-analyzer`, "Analyze what makes TikTok captions go viral"],
...
## Pricing
- [Pricing](${base}/pricing): Free tier and paid AI analysis plans
