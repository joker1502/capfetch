...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "How to Get Instagram Reels Transcripts for Free",
    description:
    ...
    contentHtml: `
      ...
      <p>Reels transcripts help you understand trending audio, replicate successful formats, and create accessible content.</p>
      ...
      <p>Our free Reels caption extractor works instantly — no registration required.</p>
    `,
  },
  {
    slug: "youtube-shorts-transcript-extractor-guide",
    title: "YouTube Shorts Transcript Extractor: The Complete Guide",
    description:
  ...
  },
  {
    ...
    title: "What Is a Transcript Generator? A Complete Guide for Creators",
    description:
    ...
    contentHtml: `
      ...
      <ul>
        ...
        <li>Create subtitles for accessibility</li>
        <li>Repurpose content across platforms</li>
        <li>Improve SEO with text content</li>
      </ul>
    `,
  },
  {
